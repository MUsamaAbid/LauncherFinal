...
Shader "Dog_P_3Col"
{
	Properties
	{
		_Dog_Map("Dog_Map", 2D) = "white" {}
		_Color_Red("Color_Red", Color) = (1,0,0.08419561,0)
		_Color_Green("Color_Green", Color) = (0.2838149,1,0,0)
		_ColorBlue("Color Blue", Color) = (0,0.2672348,1,0)
	...
	LOD 0
		...
		Pass
		{
			...
			struct v2f {
				...
				float _TessMaxDisp;
			#endif
			uniform sampler2D _Dog_Map;
			uniform float4 _Dog_Map_ST;
			uniform float4 _Color_Red;
			uniform float4 _Color_Green;
				...
				) : SV_Target 
			{
				...
				float2 uv_Dog_Map = IN.ase_texcoord9.xy * _Dog_Map_ST.xy + _Dog_Map_ST.zw;
				float4 tex2DNode6 = tex2D( _Dog_Map, uv_Dog_Map );
				
				o.Albedo = ( ( ( tex2DNode6.r * _Color_Red ) + ( tex2DNode6.g * _Color_Green ) ) + ( tex2DNode6.b * _ColorBlue ) ).rgb;
		...
		Pass
		{
			...
			) 
			{
				...
				float2 uv_Dog_Map = IN.ase_texcoord8.xy * _Dog_Map_ST.xy + _Dog_Map_ST.zw;
				float4 tex2DNode6 = tex2D( _Dog_Map, uv_Dog_Map );
		...
		Pass
		{
				...
				) : SV_Target 
			{
				...
				float2 uv_Dog_Map = IN.ase_texcoord3.xy * _Dog_Map_ST.xy + _Dog_Map_ST.zw;
				float4 tex2DNode6 = tex2D( _Dog_Map, uv_Dog_Map );
...
/*ASEBEGIN
Version=18900
135;154;1920;995;2491.272;819.472;2.324356;True;True
Node;AmplifyShaderEditor.ColorNode;8;-1761.006,90.14338;Inherit;False;Property;_Color_Green;Color_Green;2;0;Create;True;0;0;0;False;0;False;0.2838149,1,0,0;0.2838149,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;7;-1770.335,-127.6569;Inherit;False;Property;_Color_Red;Color_Red;1;0;Create;True;0;0;0;False;0;False;1,0,0.08419561,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;19;-1775.386,366.0582;Inherit;False;Property;_ColorBlue;Color Blue;3;0;Create;True;0;0;0;False;0;False;0,0.2672348,1,0;0.2838149,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-1113.802,-381.2281;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-1109.452,-159.2164;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-1170.089,192.0635;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-635.076,-38.23103;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;18;-322.0497,163.4375;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;6;-2221.625,-877.6253;Inherit;True;Property;_Dog_Map;Dog_Map;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;-23.78659,91.13655;Float;False;True;-1;2;ASEMaterialInspector;0;10;Dog_P_3Col;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;18;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;2;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;40;Workflow,InvertActionOnDeselection;1;Surface;0;  Blend;0;  Refraction Model;0;  Dither Shadows;1;Two Sided;1;Deferred Pass;1;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Ambient Light;1;Meta Pass;1;Add Pass;1;Override Baked GI;0;Extra Pre Pass;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Fwd Specular Highlights Toggle;0;Fwd Reflections Toggle;0;Disable Batching;0;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=19DB220CEAADE0EE0F7368AC43CBFEFE2F01C7A2